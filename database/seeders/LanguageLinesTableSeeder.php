    ...
    public function run()
    {
        ...
        $language_lines = array(
            ...
            array(
                ...
                'group' => 'simplecrm.company.fields',
                'key' => 'email_input',
                'text' => '{"en":"Company","id":"Enter email"}',
                'created_at' => $now,
                'updated_at' => $now,
            ),
            55 =>
            ...
            array(
                ...
                'group' => 'simplecrm.company.fields',
                'key' => 'logo_input',
                'text' => '{"en":"Company","id":"Choose logo file"}',
                'created_at' => $now,
                'updated_at' => $now,
            ),
            57 =>
            array(
                ...
                'text' => '{"en":"Company","id":"Minimum image size is 100x100."}',
                'created_at' => $now,
                'updated_at' => $now,
            ),
            58 =>
            array(
                ...
                'group' => 'simplecrm.company.fields',
                'key' => 'logo_help_edit',
                'text' => '{"en":"Company","id":"Minimum image size is 100x100. Upload image again to replace the current image."}',
                'created_at' => $now,
                'updated_at' => $now,
            ),
            59 =>
            array(
                ...
                'group' => 'simplecrm.company.fields',
                'key' => 'website_link',
                'text' => '{"en":"Company","id":"Website Link"}',
                'created_at' => $now,
                'updated_at' => $now,
            ),
            60 =>
            array(
                ...
                'text' => '{"en":"Company","id":"Enter website link"}',
                'created_at' => $now,
                'updated_at' => $now,
            ),
            61 =>
